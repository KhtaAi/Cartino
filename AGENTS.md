...
- اصلاح متن‌های بیومتریک (حذف واژه «چهره» و اشاره اختصاصی به اثر انگشت) و بهبود چیدمان چیپ‌های زمان پاکسازی کلیپ‌بورد با FlowRow در تاریخ 2026-08-10 انجام شد.
```
